 const worldNodes = [
    {
      ...
      goods: [
        "Basic Cargo Pack",
        "Luxury Porcelain Cargo Pack",
        "Rare Wine Cargo Pack",
        "Ancient Literature Cargo Pack",
        "Whirlpool Isle Refined Crystal",
        "Delphinad Ghost Ship Stone Slab",
   ...
   const auroriaNodes = [
    {
      name: "Calmlands",
      goods: ["Calmlands Fern Salad"]
    },
    {
      name: "Exeloch",
      goods: ["Exeloch Organic Gems"]
    },
    {
      name: "Heedmar",
      goods: ["Heedmar Scented Oils"]
    },
    {
      name: "Marcala",
      goods: ["Marcala Scented Candles"]
    },
    {
      name: "Nuimari",
      goods: ["Nuimari Dried Roots"]
    },
    {
      name: "Sungold Fields",
      goods: ["Sungold Thorn Combs"]
    }
  ]
  
   const haranyaPortNodes = [
    {
      name: "Solis Headlands",
      goldPack: "Solis Juice Concentrate",
      gildaPack: "Solis Alchemy Oil",
      fellowshipPack: "Solis Red Spice",
      fertPack: "Solis Fertilizer",
      agedPack: "Solis Honey",
      communityPack: "Solis Cheese/Salve"
    },
    {
      name: "Villanelle",
      goldPack: "Villanelle Preserved Cherries",
      gildaPack: "Villanelle Potpourri",
      fellowshipPack: "Villanelle Long Noodles",
      fertPack: "Villanelle Fertilizer",
      agedPack: "Villanelle Honey",
      communityPack: "Villanelle Cheese/Salve"
    },
    {
      name: "Ynystere",
      goldPack: "Ynystere Olive Oil",
      gildaPack: "Ynystere Preserves",
      fellowshipPack: "Ynystere Bouquets",
      fertPack: "Ynystere Fertilizer",
      agedPack: "Ynystere Honey",
      communityPack: "Ynystere Cheese/Salve"
    }
  ]
  
   const haranyaTradeNodes = [
    {
      name: "Arcum Iris",
      goldPack: "Arcum Iris Lavaspice",
      gildaPack: "Arcum Iris Roasted Eggs",
      fellowshipPack: "Arcum Iris Salt Crackers",
      fertPack: "Arcum Iris Fertilizer",
      agedPack: "Arcum Iris Honey",
      communityPack: "Arcum Iris Cheese/Salve"
    },
    {
      name: "Falcorth Plains",
      goldPack: "Falcorth Plains Apple Tarts",
      gildaPack: "Falcorth Snowlion Yam",
      fellowshipPack: "Falcorth Plains Fertilizer",
      fertPack: "Falcorth Fertilizer",
      agedPack: "Falcorth Plains Honey",
      communityPack: "Falcorth Plains Cheese/Salve"
    },
    {
      name: "Hasla",
      goldPack: "Hasla Cured Meat",
      gildaPack: "Hasla Softened Fabric",
      fellowshipPack: "Hasla Specialty Tea",
      fertPack: "Hasla Fertilizer",
      agedPack: "Hasla Honey",
      communityPack: "Hasla Cheese/Salve"
    },
    {
      name: "Mahadevi",
      goldPack: "Mahadevi Root Herbs",
      gildaPack: "Mahadevi Elephant Cookies",
      fellowshipPack: "Mahadevi Pickles",
      fertPack: "Mahadevi Fertilizer",
      agedPack: "Mahadevi Honey",
      communityPack: "Mahadevi Cheese/Salve"
    },
    {
      name: "Perinoor Ruins",
      goldPack: "Perinoor Potato Powder",
      gildaPack: "Perinoor Aged Spices",
      fellowshipPack: "Perinoor Fried Meat",
      fertPack: "Perinoor Fertilizer",
      agedPack: "Perinoor Honey",
      communityPack: "Perinoor Cheese/Salve"
    },
    {
      name: "Rokhala Mountains",
      goldPack: "Rokhala Auspicious Elixir",
      gildaPack: "Rokhala Alpine Mix",
      fellowshipPack: "Rokhala Livestock Fodder",
      fertPack: "Rokhala Fertilizer",
      agedPack: "Rokhala Honey",
      communityPack: "Rokhala Cheese/Salve"
    },
    {
      name: "Rookborne Basin",
      goldPack: "Rookborne Fruit Leather",
      gildaPack: "Rookborne Biscuit Sticks",
      fellowshipPack: "Rookborne Basin Corn Hash",
      fertPack: "Rookborne Fertilizer",
      agedPack: "Rookborne Honey",
      communityPack: "Rookborne Cheese/Salve"
    },
    {
      name: "Silent Forest",
      goldPack: "Silent Forest Pomme Candy",
      gildaPack: "Silent Forest Dried Fruit",
      fellowshipPack: "Silent Forest Seasonings",
      fertPack: "Silent Forest Fertilizer",
      agedPack: "Silent Forest Honey",
      communityPack: "Silent Forest Cheese/Salve"
    },
    {
      name: "Sunbite Wilds",
      goldPack: "Sunbite Salvation Tea",
      gildaPack: "Sunbite Citrus Cleaner",
      fellowshipPack: "Sunbite Pest Poison",
      fertPack: "Sunbite Fertilizer",
      agedPack: "Sunbite Honey",
      communityPack: "Sunbite Cheese/Salve"
    },
    {
      name: "Tigerspine Mountains",
      goldPack: "Tigerspine Grape Jam",
      gildaPack: "Tigerspine Tigerspaw Pancakes",
      fellowshipPack: "Tigerspine Seasoned Meat",
      fertPack: "Tigerspine Fertilizer",
      agedPack: "Tigerspine Honey",
      communityPack: "Tigerspine Cheese/Salve"
    },
    {
      name: "Windscour Savannah",
      goldPack: "Windscour Bitter Herbs",
      gildaPack: "Windscour Hearty Jerky",
      fellowshipPack: "Windscour Chilled Beverages",
      fertPack: "Windscour Fertilizer",
      agedPack: "Windscour Honey",
      communityPack: "Windscour Cheese/Salve"
    }
  ]
   ...
   const nuiaPortNodes = [
    {
      ...
      goldPack: "Cinderstone Sacred Candles",
      gildaPack: "Cinderstone Tart Mead",
      fellowshipPack: "Cinderstone Medicinal Powder",
      fertPack: "Cinderstone Fertilizer",
      agedPack: "Cinderstone Honey",
      communityPack: "Cinderstone Cheese/Salve"
    },
    {
      name: "Solzreed Peninsula",
      goldPack: "Solzreed Dried Food",
      gildaPack: "Solzreed Braised Meat",
      fellowshipPack: "Solzreed Strawberry Smoothies",
      fertPack: "Solzreed Fertilizer",
      agedPack: "Solzreed Honey",
      communityPack: "Solzreed Cheese/Salve"
    },
    {
      name: "Two Crowns",
      goldPack: "Two Crowns Pomme Cakes",
      gildaPack: "Two Crowns Cream",
      fellowshipPack: "Two Crowns Flowerpots",
      fertPack: "Two Crowns Fertilizer",
      agedPack: "Two Crowns Honey",
      communityPack: "Two Crowns Cheese/Salve"
    }
  ]
  
   const nuiaTradeNodes = [
    {
      name: "Ahnimar",
      goldPack: "Ahnimar Mushroom Roulette",
      gildaPack: "Ahnimar Hangover Cure",
      fellowshipPack: "Ahnimar Pressed Powder",
      fertPack: "Ahnimar Fertilizer",
      agedPack: "Ahnimar Honey",
      communityPack: "Ahnimar Cheese/Salve"
    },
    {
      name: "Airain Rock",
      goldPack: "Airain Triple Stout",
      gildaPack: "Airain Dream Catchers",
      fellowshipPack: "Airain Vegetable Seasoning",
      fertPack: "Airain Fertilizer",
      agedPack: "Airain Honey",
      communityPack: "Airain Cheese/Salve"
    },
    {
      name: "Aubre Cradle",
      goldPack: "Aubre Cradle Ethanol",
      gildaPack: "Aubre Cradle Rice Flour",
      fellowshipPack: "Aubre Cradle Deviled Eggs",
      fertPack: "Aubre Cradle Fertilizer",
      agedPack: "Aubre Cradle Honey",
      communityPack: "Aubre Cradle Cheese/Salve"
    },
    {
      name: "Dewstone Plains",
      goldPack: "Dewstone Distilled Liquor",
      gildaPack: "Dewstone Fine Thread",
      fellowshipPack: "Dewstone Toy Robots",
      fertPack: "Dewstone Fertilizer",
      agedPack: "Dewstone Honey",
      communityPack: "Dewstone Cheese/Salve"
    },
    {
      name: "Gweonid Forest",
      goldPack: "Gweonid Apple Pies",
      gildaPack: "Gweonid Dyed Feathers",
      fellowshipPack: "Gweonid Piquant Spices",
      fertPack: "Gweonid Fertilizer",
      agedPack: "Gweonid Honey",
      communityPack: "Gweonid Cheese/Salve"
    },
    {
      name: "Halcyona",
      goldPack: "Halcyona Yam Pasta",
      gildaPack: "Halcyona Wheat Biscuit",
      fellowshipPack: "Halcyona Livestock Feed",
      fertPack: "Halcyona Fertilizer",
      agedPack: "Halcyona Honey",
      communityPack: "Halcyona Cheese/Salve"
    },
    {
      name: "Hellswamp",
      goldPack: "Hellswamp Mushroom Pot Pies",
      gildaPack: "Hellswamp Spicy Meat",
      fellowshipPack: "Hellswamp Ground Peanuts",
      fertPack: "Hellswamp Fertilizer",
      agedPack: "Hellswamp Honey",
      communityPack: "Hellswamp Cheese/Salve"
    },
    {
      name: "Karkasse Ridgelands",
      goldPack: "Karkasse Dragon Jerky",
      gildaPack: "Karkasse Quilts",
      fellowshipPack: "Karkasse Burn Cream",
      fertPack: "Karkasse Fertilizer",
      agedPack: "Karkasse Honey",
      communityPack: "Karkasse Cheese/Salve"
    },
    {
      name: "Lilyut Hills",
      goldPack: "Lilyut Hills Cooking Oil",
      gildaPack: "Lilyut Hills Milk Soap",
      fellowshipPack: "Lilyut Hills Barley Moonshine",
      fertPack: "Lilyut Fertilizer",
      agedPack: "Lilyut Honey",
      communityPack: "Lilyut Cheese/Salve"
    },
    {
      name: "Marianople",
      goldPack: "Marianople Sweeteners",
      gildaPack: "Marianople Duck Down",
      fellowshipPack: "Marianople Face Cream",
      fertPack: "Marianople Fertilizer",
      agedPack: "Marianople Honey",
      communityPack: "Marianople Cheese/Salve"
    },
    {
      name: "Sanddeep",
      goldPack: "Sanddeep Preserved Meat",
      gildaPack: "Sanddeep Medicinal Poultice",
      fellowshipPack: "Sanddeep Fried Cucumbers",
      fertPack: "Sanddeep Fertilizer",
      agedPack: "Sanddeep Honey",
      communityPack: "Sanddeep Cheese/Salve"
    },
    {
      name: "White Arden",
      goldPack: "White Arden Figgy Pudding",
      gildaPack: "White Arden Trail Mix",
      fellowshipPack: "White Arden Grilled Meat",
      fertPack: "White Arden Fertilizer",
      agedPack: "White Arden Honey",
      communityPack: "White Arden Cheese/Salve"
    }
  ]
  ...
  ;(function(currencyType) {
    ...
    currencyType["gilda"] = "Gilda Stars"
    currencyType["dragon"] = "Dragon Stabilizers"
    currencyType["charcoal"] = "Charcoal Stabilizers"
  ...
  for (var nodeArray of allNodes) {
      for (var node of nodeArray) {
          ...
          for (var otherNodeArray of allNodes) {
              for (var otherNode of otherNodeArray) {
                  const otherNodeName = otherNode.name;
                  console.log("Initializing " + nodeName + " and " + otherNodeName)
                  goldNodes[nodeName][otherNodeName] = {
                      goldValue: -1,
                      gildaValue: -1,
                      fellowshipValue: -1,
                      fertValue: -1,
                  ...
                  gildaNodes[nodeName][otherNodeName] = {
                      goldValue: -1,
                      gildaValue: -1,
                      fellowshipValue: -1,
                      fertValue: -1,
                  ...
                  stabNodes[nodeName][otherNodeName] = {
                      goldValue: -1,
                      gildaValue: -1,
                      fellowshipValue: -1,
                      fertValue: -1,
...
function generateHaranyaGGFGoldValues() {
    ...
    goldNodes["Tigerspine Mountains"]["Falcorth Plains"].fellowshipValue = 6.0258;
    ...
    goldNodes["Tigerspine Mountains"]["Solis Headlands"].fellowshipValue = 8.8825;
    ...
    goldNodes["Tigerspine Mountains"]["Rookborne Basin"].fellowshipValue = 12.029;
    ...
    goldNodes["Tigerspine Mountains"]["Freedich Island"].fellowshipValue = 22.8952;
...
function generateNuiaGGFGoldValues() {
    ...
    goldNodes["Solzreed Peninsula"]["Cinderstone Moor"].fellowshipValue = 14.8963;
    ...
    goldNodes["Cinderstone Moor"]["Solzreed Peninsula"].fellowshipValue = 14.8963;
    ...
    goldNodes["Karkasse Ridgelands"]["Solzreed Peninsula"].fellowshipValue = 15.3374;
    ...
    goldNodes["Karkasse Ridgelands"]["Dewstone Plains"].fellowshipValue = 11.5073;
    ...
    goldNodes["Karkasse Ridgelands"]["Cinderstone Moor"].fellowshipValue = 16.6777;
    ...
    goldNodes["Karkasse Ridgelands"]["Freedich Island"].fellowshipValue = 28.5844;
...
function generateNuiaGGFStabValues() {
    ...
    stabNodes["Solzreed Peninsula"]["Ynystere"].gildaValue = 15;
    stabNodes["Solzreed Peninsula"]["Ynystere"].fellowshipValue = 4;
    stabNodes["Solzreed Peninsula"]["Villanelle"].goldValue = 15;
    stabNodes["Solzreed Peninsula"]["Villanelle"].gildaValue = 16;
    stabNodes["Solzreed Peninsula"]["Villanelle"].fellowshipValue = 8;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].goldValue = 13;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].gildaValue = 14;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].fellowshipValue = 11;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].goldValue = 1;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].gildaValue = 1;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].fellowshipValue = 1;
    stabNodes["Gweonid Forest"]["Ynystere"].goldValue = 20;
    stabNodes["Gweonid Forest"]["Ynystere"].gildaValue = 22;
    stabNodes["Gweonid Forest"]["Ynystere"].fellowshipValue = 21;
    stabNodes["Gweonid Forest"]["Villanelle"].goldValue = 21;
    stabNodes["Gweonid Forest"]["Villanelle"].gildaValue = 23;
    stabNodes["Gweonid Forest"]["Villanelle"].fellowshipValue = 22;
    stabNodes["Gweonid Forest"]["Solis Headlands"].goldValue = 20;
    stabNodes["Gweonid Forest"]["Solis Headlands"].gildaValue = 21;
    stabNodes["Gweonid Forest"]["Solis Headlands"].fellowshipValue = 21;
    stabNodes["Gweonid Forest"]["Freedich Island"].goldValue = 1;
    stabNodes["Gweonid Forest"]["Freedich Island"].gildaValue = 1;
    stabNodes["Gweonid Forest"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Lilyut Hills"]["Ynystere"].goldValue = 17;
    stabNodes["Lilyut Hills"]["Ynystere"].gildaValue = 19;
    stabNodes["Lilyut Hills"]["Ynystere"].fellowshipValue = 18;
    stabNodes["Lilyut Hills"]["Villanelle"].goldValue = 19;
    stabNodes["Lilyut Hills"]["Villanelle"].gildaValue = 20;
    stabNodes["Lilyut Hills"]["Villanelle"].fellowshipValue = 19;
    stabNodes["Lilyut Hills"]["Solis Headlands"].goldValue = 18;
    stabNodes["Lilyut Hills"]["Solis Headlands"].gildaValue = 19;
    stabNodes["Lilyut Hills"]["Solis Headlands"].fellowshipValue = 18;
    stabNodes["Lilyut Hills"]["Freedich Island"].goldValue = 1;
    stabNodes["Lilyut Hills"]["Freedich Island"].gildaValue = 1;
    stabNodes["Lilyut Hills"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Dewstone Plains"]["Ynystere"].goldValue = 18;
    stabNodes["Dewstone Plains"]["Ynystere"].gildaValue = 20;
    stabNodes["Dewstone Plains"]["Ynystere"].fellowshipValue = 19;
    stabNodes["Dewstone Plains"]["Villanelle"].goldValue = 18;
    stabNodes["Dewstone Plains"]["Villanelle"].gildaValue = 20;
    stabNodes["Dewstone Plains"]["Villanelle"].fellowshipValue = 19;
    stabNodes["Dewstone Plains"]["Solis Headlands"].goldValue = 16;
    stabNodes["Dewstone Plains"]["Solis Headlands"].gildaValue = 17;
    stabNodes["Dewstone Plains"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["Dewstone Plains"]["Freedich Island"].goldValue = 1;
    stabNodes["Dewstone Plains"]["Freedich Island"].gildaValue = 1;
    stabNodes["Dewstone Plains"]["Freedich Island"].fellowshipValue = 1;
    stabNodes["White Arden"]["Ynystere"].goldValue = 20;
    stabNodes["White Arden"]["Ynystere"].gildaValue = 21;
    stabNodes["White Arden"]["Ynystere"].fellowshipValue = 21;
    stabNodes["White Arden"]["Villanelle"].goldValue = 20;
    stabNodes["White Arden"]["Villanelle"].gildaValue = 22;
    stabNodes["White Arden"]["Villanelle"].fellowshipValue = 21;
    stabNodes["White Arden"]["Solis Headlands"].goldValue = 17;
    stabNodes["White Arden"]["Solis Headlands"].gildaValue = 18;
    stabNodes["White Arden"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["White Arden"]["Freedich Island"].goldValue = 1;
    stabNodes["White Arden"]["Freedich Island"].gildaValue = 1;
    stabNodes["White Arden"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Marianople"]["Ynystere"].goldValue = 19;
    stabNodes["Marianople"]["Ynystere"].gildaValue = 20;
    stabNodes["Marianople"]["Ynystere"].fellowshipValue = 20;
    stabNodes["Marianople"]["Villanelle"].goldValue = 19;
    stabNodes["Marianople"]["Villanelle"].gildaValue = 20;
    stabNodes["Marianople"]["Villanelle"].fellowshipValue = 20;
    stabNodes["Marianople"]["Solis Headlands"].goldValue = 15;
    stabNodes["Marianople"]["Solis Headlands"].gildaValue = 16;
    stabNodes["Marianople"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["Marianople"]["Freedich Island"].goldValue = 1;
    stabNodes["Marianople"]["Freedich Island"].gildaValue = 1;
    stabNodes["Marianople"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Two Crowns"]["Ynystere"].goldValue = 16;
    stabNodes["Two Crowns"]["Ynystere"].gildaValue = 17;
    stabNodes["Two Crowns"]["Ynystere"].fellowshipValue = 17;
    stabNodes["Two Crowns"]["Villanelle"].goldValue = 15;
    stabNodes["Two Crowns"]["Villanelle"].gildaValue = 17;
    stabNodes["Two Crowns"]["Villanelle"].fellowshipValue = 17;
    stabNodes["Two Crowns"]["Solis Headlands"].goldValue = 11;
    stabNodes["Two Crowns"]["Solis Headlands"].gildaValue = 11;
    stabNodes["Two Crowns"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["Two Crowns"]["Freedich Island"].goldValue = 1;
    stabNodes["Two Crowns"]["Freedich Island"].gildaValue = 1;
    stabNodes["Two Crowns"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Cinderstone Moor"]["Ynystere"].goldValue = 14;
    stabNodes["Cinderstone Moor"]["Ynystere"].gildaValue = 15;
    stabNodes["Cinderstone Moor"]["Ynystere"].fellowshipValue = 22;
    stabNodes["Cinderstone Moor"]["Villanelle"].goldValue = 14;
    stabNodes["Cinderstone Moor"]["Villanelle"].gildaValue = 15;
    stabNodes["Cinderstone Moor"]["Villanelle"].fellowshipValue = 21;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].goldValue = 10;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].gildaValue = 11;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["Cinderstone Moor"]["Freedich Island"].goldValue = 1;
    stabNodes["Cinderstone Moor"]["Freedich Island"].gildaValue = 1;
    stabNodes["Cinderstone Moor"]["Freedich Island"].fellowshipValue = 1;
    stabNodes["Halcyona"]["Ynystere"].goldValue = 21;
    stabNodes["Halcyona"]["Ynystere"].gildaValue = 23;
    stabNodes["Halcyona"]["Ynystere"].fellowshipValue = 22;
    stabNodes["Halcyona"]["Villanelle"].goldValue = 21;
    stabNodes["Halcyona"]["Villanelle"].gildaValue = 22;
    stabNodes["Halcyona"]["Villanelle"].fellowshipValue = 22;
    stabNodes["Halcyona"]["Solis Headlands"].goldValue = 16;
    stabNodes["Halcyona"]["Solis Headlands"].gildaValue = 17;
    stabNodes["Halcyona"]["Solis Headlands"].fellowshipValue = 17;
    stabNodes["Halcyona"]["Freedich Island"].goldValue = 1;
    stabNodes["Halcyona"]["Freedich Island"].gildaValue = 1;
    stabNodes["Halcyona"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Hellswamp"]["Ynystere"].goldValue = 24;
    stabNodes["Hellswamp"]["Ynystere"].gildaValue = 26;
    stabNodes["Hellswamp"]["Ynystere"].fellowshipValue = 21;
    stabNodes["Hellswamp"]["Villanelle"].goldValue = 23;
    stabNodes["Hellswamp"]["Villanelle"].gildaValue = 25;
    stabNodes["Hellswamp"]["Villanelle"].fellowshipValue = 20;
    stabNodes["Hellswamp"]["Solis Headlands"].goldValue = 19;
    stabNodes["Hellswamp"]["Solis Headlands"].gildaValue = 20;
    stabNodes["Hellswamp"]["Solis Headlands"].fellowshipValue = 20;
    stabNodes["Hellswamp"]["Freedich Island"].goldValue = 1;
    stabNodes["Hellswamp"]["Freedich Island"].gildaValue = 1;
    stabNodes["Hellswamp"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Sanddeep"]["Ynystere"].goldValue = 21;
    stabNodes["Sanddeep"]["Ynystere"].gildaValue = 22;
    stabNodes["Sanddeep"]["Ynystere"].fellowshipValue = 21;
    stabNodes["Sanddeep"]["Villanelle"].goldValue = 20;
    stabNodes["Sanddeep"]["Villanelle"].gildaValue = 21;
    stabNodes["Sanddeep"]["Villanelle"].fellowshipValue = 20;
    stabNodes["Sanddeep"]["Solis Headlands"].goldValue = 15;
    stabNodes["Sanddeep"]["Solis Headlands"].gildaValue = 16;
    stabNodes["Sanddeep"]["Solis Headlands"].fellowshipValue = 16;
    stabNodes["Sanddeep"]["Freedich Island"].goldValue = 1;
    stabNodes["Sanddeep"]["Freedich Island"].gildaValue = 1;
    stabNodes["Sanddeep"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].goldValue = 42;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].gildaValue = 45;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].fellowshipValue = 43;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].goldValue = 43;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].gildaValue = 47;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].fellowshipValue = 45;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].goldValue = 40;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].gildaValue = 44;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].fellowshipValue = 42;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].goldValue = 2;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].gildaValue = 2;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].fellowshipValue = 2;
    stabNodes["Airain Rock"]["Ynystere"].goldValue = 25;
    stabNodes["Airain Rock"]["Ynystere"].gildaValue = 27;
    stabNodes["Airain Rock"]["Ynystere"].fellowshipValue = 25;
    stabNodes["Airain Rock"]["Villanelle"].goldValue = 25;
    stabNodes["Airain Rock"]["Villanelle"].gildaValue = 27;
    stabNodes["Airain Rock"]["Villanelle"].fellowshipValue = 26;
    stabNodes["Airain Rock"]["Solis Headlands"].goldValue = 21;
    stabNodes["Airain Rock"]["Solis Headlands"].gildaValue = 23;
    stabNodes["Airain Rock"]["Solis Headlands"].fellowshipValue = 22;
    stabNodes["Airain Rock"]["Freedich Island"].goldValue = 1;
    stabNodes["Airain Rock"]["Freedich Island"].gildaValue = 1;
    stabNodes["Airain Rock"]["Freedich Island"].fellowshipValue = 1;
    stabNodes["Aubre Cradle"]["Ynystere"].goldValue = 22;
    stabNodes["Aubre Cradle"]["Ynystere"].gildaValue = 24;
    stabNodes["Aubre Cradle"]["Ynystere"].fellowshipValue = 23;
    stabNodes["Aubre Cradle"]["Villanelle"].goldValue = 22;
    stabNodes["Aubre Cradle"]["Villanelle"].gildaValue = 24;
    stabNodes["Aubre Cradle"]["Villanelle"].fellowshipValue = 23;
    stabNodes["Aubre Cradle"]["Solis Headlands"].goldValue = 19;
    stabNodes["Aubre Cradle"]["Solis Headlands"].gildaValue = 20;
    stabNodes["Aubre Cradle"]["Solis Headlands"].fellowshipValue = 19;
    stabNodes["Aubre Cradle"]["Freedich Island"].goldValue = 1;
    stabNodes["Aubre Cradle"]["Freedich Island"].gildaValue = 1;
    stabNodes["Aubre Cradle"]["Freedich Island"].fellowshipValue = 1;
    stabNodes["Ahnimar"]["Ynystere"].goldValue = 26;
    stabNodes["Ahnimar"]["Ynystere"].gildaValue = 28;
    stabNodes["Ahnimar"]["Ynystere"].fellowshipValue = 27;
    stabNodes["Ahnimar"]["Villanelle"].goldValue = 26;
    stabNodes["Ahnimar"]["Villanelle"].gildaValue = 28;
    stabNodes["Ahnimar"]["Villanelle"].fellowshipValue = 27;
    stabNodes["Ahnimar"]["Solis Headlands"].goldValue = 21;
    stabNodes["Ahnimar"]["Solis Headlands"].gildaValue = 23;
    stabNodes["Ahnimar"]["Solis Headlands"].fellowshipValue = 22;
    stabNodes["Ahnimar"]["Freedich Island"].goldValue = 1;
    stabNodes["Ahnimar"]["Freedich Island"].gildaValue = 2;
    stabNodes["Ahnimar"]["Freedich Island"].fellowshipValue = 1;
}
...
function generateNuiaFHCGildaValues() {
    gildaNodes["Solzreed Peninsula"]["Ynystere"].fertValue = 3;
    gildaNodes["Solzreed Peninsula"]["Ynystere"].honeyValue = 3;
    gildaNodes["Solzreed Peninsula"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Solzreed Peninsula"]["Villanelle"].fertValue = 2;
    gildaNodes["Solzreed Peninsula"]["Villanelle"].honeyValue = 2;
    gildaNodes["Solzreed Peninsula"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Solzreed Peninsula"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Solzreed Peninsula"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Solzreed Peninsula"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Solzreed Peninsula"]["Freedich Island"].fertValue = 5;
    gildaNodes["Solzreed Peninsula"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Solzreed Peninsula"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Gweonid Forest"]["Ynystere"].fertValue = 3;
    gildaNodes["Gweonid Forest"]["Ynystere"].honeyValue = 3;
    gildaNodes["Gweonid Forest"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Gweonid Forest"]["Villanelle"].fertValue = 2;
    gildaNodes["Gweonid Forest"]["Villanelle"].honeyValue = 2;
    gildaNodes["Gweonid Forest"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Gweonid Forest"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Gweonid Forest"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Gweonid Forest"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Gweonid Forest"]["Freedich Island"].fertValue = 5;
    gildaNodes["Gweonid Forest"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Gweonid Forest"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Lilyut Hills"]["Ynystere"].fertValue = 3;
    gildaNodes["Lilyut Hills"]["Ynystere"].honeyValue = 3;
    gildaNodes["Lilyut Hills"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Lilyut Hills"]["Villanelle"].fertValue = 2;
    gildaNodes["Lilyut Hills"]["Villanelle"].honeyValue = 2;
    gildaNodes["Lilyut Hills"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Lilyut Hills"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Lilyut Hills"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Lilyut Hills"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Lilyut Hills"]["Freedich Island"].fertValue = 5;
    gildaNodes["Lilyut Hills"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Lilyut Hills"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Dewstone Plains"]["Ynystere"].fertValue = 3;
    gildaNodes["Dewstone Plains"]["Ynystere"].honeyValue = 3;
    gildaNodes["Dewstone Plains"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Dewstone Plains"]["Villanelle"].fertValue = 2;
    gildaNodes["Dewstone Plains"]["Villanelle"].honeyValue = 2;
    gildaNodes["Dewstone Plains"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Dewstone Plains"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Dewstone Plains"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Dewstone Plains"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Dewstone Plains"]["Freedich Island"].fertValue = 5;
    gildaNodes["Dewstone Plains"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Dewstone Plains"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["White Arden"]["Ynystere"].fertValue = 3;
    gildaNodes["White Arden"]["Ynystere"].honeyValue = 3;
    gildaNodes["White Arden"]["Ynystere"].cheeseValue = 3;
    gildaNodes["White Arden"]["Villanelle"].fertValue = 2;
    gildaNodes["White Arden"]["Villanelle"].honeyValue = 2;
    gildaNodes["White Arden"]["Villanelle"].cheeseValue = 2;
    gildaNodes["White Arden"]["Solis Headlands"].fertValue = 2;
    gildaNodes["White Arden"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["White Arden"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["White Arden"]["Freedich Island"].fertValue = 5;
    gildaNodes["White Arden"]["Freedich Island"].honeyValue = 5;
    gildaNodes["White Arden"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Marianople"]["Ynystere"].fertValue = 3;
    gildaNodes["Marianople"]["Ynystere"].honeyValue = 3;
    gildaNodes["Marianople"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Marianople"]["Villanelle"].fertValue = 2;
    gildaNodes["Marianople"]["Villanelle"].honeyValue = 2;
    gildaNodes["Marianople"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Marianople"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Marianople"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Marianople"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Marianople"]["Freedich Island"].fertValue = 5;
    gildaNodes["Marianople"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Marianople"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Two Crowns"]["Ynystere"].fertValue = 3;
    gildaNodes["Two Crowns"]["Ynystere"].honeyValue = 3;
    gildaNodes["Two Crowns"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Two Crowns"]["Villanelle"].fertValue = 2;
    gildaNodes["Two Crowns"]["Villanelle"].honeyValue = 2;
    gildaNodes["Two Crowns"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Two Crowns"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Two Crowns"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Two Crowns"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Two Crowns"]["Freedich Island"].fertValue = 5;
    gildaNodes["Two Crowns"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Two Crowns"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Cinderstone Moor"]["Ynystere"].fertValue = 2;
    gildaNodes["Cinderstone Moor"]["Ynystere"].honeyValue = 2;
    gildaNodes["Cinderstone Moor"]["Ynystere"].cheeseValue = 2;
    gildaNodes["Cinderstone Moor"]["Villanelle"].fertValue = 1;
    gildaNodes["Cinderstone Moor"]["Villanelle"].honeyValue = 1;
    gildaNodes["Cinderstone Moor"]["Villanelle"].cheeseValue = 1;
    gildaNodes["Cinderstone Moor"]["Solis Headlands"].fertValue = 1;
    gildaNodes["Cinderstone Moor"]["Solis Headlands"].honeyValue = 1;
    gildaNodes["Cinderstone Moor"]["Solis Headlands"].cheeseValue = 1;
    gildaNodes["Cinderstone Moor"]["Freedich Island"].fertValue = 4;
    gildaNodes["Cinderstone Moor"]["Freedich Island"].honeyValue = 4;
    gildaNodes["Cinderstone Moor"]["Freedich Island"].cheeseValue = 4;
    gildaNodes["Halcyona"]["Ynystere"].fertValue = 3;
    gildaNodes["Halcyona"]["Ynystere"].honeyValue = 3;
    gildaNodes["Halcyona"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Halcyona"]["Villanelle"].fertValue = 2;
    gildaNodes["Halcyona"]["Villanelle"].honeyValue = 2;
    gildaNodes["Halcyona"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Halcyona"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Halcyona"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Halcyona"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Halcyona"]["Freedich Island"].fertValue = 5;
    gildaNodes["Halcyona"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Halcyona"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Hellswamp"]["Ynystere"].fertValue = 3;
    gildaNodes["Hellswamp"]["Ynystere"].honeyValue = 3;
    gildaNodes["Hellswamp"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Hellswamp"]["Villanelle"].fertValue = 2;
    gildaNodes["Hellswamp"]["Villanelle"].honeyValue = 2;
    gildaNodes["Hellswamp"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Hellswamp"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Hellswamp"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Hellswamp"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Hellswamp"]["Freedich Island"].fertValue = 5;
    gildaNodes["Hellswamp"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Hellswamp"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Sanddeep"]["Ynystere"].fertValue = 3;
    gildaNodes["Sanddeep"]["Ynystere"].honeyValue = 3;
    gildaNodes["Sanddeep"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Sanddeep"]["Villanelle"].fertValue = 2;
    gildaNodes["Sanddeep"]["Villanelle"].honeyValue = 2;
    gildaNodes["Sanddeep"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Sanddeep"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Sanddeep"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Sanddeep"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Sanddeep"]["Freedich Island"].fertValue = 5;
    gildaNodes["Sanddeep"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Sanddeep"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Karkasse Ridgelands"]["Ynystere"].fertValue = 3;
    gildaNodes["Karkasse Ridgelands"]["Ynystere"].honeyValue = 3;
    gildaNodes["Karkasse Ridgelands"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Karkasse Ridgelands"]["Villanelle"].fertValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Villanelle"].honeyValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Karkasse Ridgelands"]["Freedich Island"].fertValue = 5;
    gildaNodes["Karkasse Ridgelands"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Karkasse Ridgelands"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Airain Rock"]["Ynystere"].fertValue = 3;
    gildaNodes["Airain Rock"]["Ynystere"].honeyValue = 3;
    gildaNodes["Airain Rock"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Airain Rock"]["Villanelle"].fertValue = 2;
    gildaNodes["Airain Rock"]["Villanelle"].honeyValue = 2;
    gildaNodes["Airain Rock"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Airain Rock"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Airain Rock"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Airain Rock"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Airain Rock"]["Freedich Island"].fertValue = 5;
    gildaNodes["Airain Rock"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Airain Rock"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Aubre Cradle"]["Ynystere"].fertValue = 3;
    gildaNodes["Aubre Cradle"]["Ynystere"].honeyValue = 3;
    gildaNodes["Aubre Cradle"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Aubre Cradle"]["Villanelle"].fertValue = 2;
    gildaNodes["Aubre Cradle"]["Villanelle"].honeyValue = 2;
    gildaNodes["Aubre Cradle"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Aubre Cradle"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Aubre Cradle"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Aubre Cradle"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Aubre Cradle"]["Freedich Island"].fertValue = 5;
    gildaNodes["Aubre Cradle"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Aubre Cradle"]["Freedich Island"].cheeseValue = 5;
    gildaNodes["Ahnimar"]["Ynystere"].fertValue = 3;
    gildaNodes["Ahnimar"]["Ynystere"].honeyValue = 3;
    gildaNodes["Ahnimar"]["Ynystere"].cheeseValue = 3;
    gildaNodes["Ahnimar"]["Villanelle"].fertValue = 2;
    gildaNodes["Ahnimar"]["Villanelle"].honeyValue = 2;
    gildaNodes["Ahnimar"]["Villanelle"].cheeseValue = 2;
    gildaNodes["Ahnimar"]["Solis Headlands"].fertValue = 2;
    gildaNodes["Ahnimar"]["Solis Headlands"].honeyValue = 2;
    gildaNodes["Ahnimar"]["Solis Headlands"].cheeseValue = 2;
    gildaNodes["Ahnimar"]["Freedich Island"].fertValue = 5;
    gildaNodes["Ahnimar"]["Freedich Island"].honeyValue = 5;
    gildaNodes["Ahnimar"]["Freedich Island"].cheeseValue = 5;
}
function generateNuiaFHCStabValues() {
    stabNodes["Solzreed Peninsula"]["Ynystere"].fertValue = 14;
    stabNodes["Solzreed Peninsula"]["Ynystere"].honeyValue = 23;
    stabNodes["Solzreed Peninsula"]["Ynystere"].cheeseValue = 23;
    stabNodes["Solzreed Peninsula"]["Villanelle"].fertValue = 15;
    stabNodes["Solzreed Peninsula"]["Villanelle"].honeyValue = 25;
    stabNodes["Solzreed Peninsula"]["Villanelle"].cheeseValue = 25;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].fertValue = 13;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].honeyValue = 22;
    stabNodes["Solzreed Peninsula"]["Solis Headlands"].cheeseValue = 22;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].fertValue = 1;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].honeyValue = 3;
    stabNodes["Solzreed Peninsula"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Gweonid Forest"]["Ynystere"].fertValue = 21;
    stabNodes["Gweonid Forest"]["Ynystere"].honeyValue = 34;
    stabNodes["Gweonid Forest"]["Ynystere"].cheeseValue = 34;
    stabNodes["Gweonid Forest"]["Villanelle"].fertValue = 22;
    stabNodes["Gweonid Forest"]["Villanelle"].honeyValue = 36;
    stabNodes["Gweonid Forest"]["Villanelle"].cheeseValue = 36;
    stabNodes["Gweonid Forest"]["Solis Headlands"].fertValue = 20;
    stabNodes["Gweonid Forest"]["Solis Headlands"].honeyValue = 34;
    stabNodes["Gweonid Forest"]["Solis Headlands"].cheeseValue = 34;
    stabNodes["Gweonid Forest"]["Freedich Island"].fertValue = 1;
    stabNodes["Gweonid Forest"]["Freedich Island"].honeyValue = 3;
    stabNodes["Gweonid Forest"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Lilyut Hills"]["Ynystere"].fertValue = 18;
    stabNodes["Lilyut Hills"]["Ynystere"].honeyValue = 29;
    stabNodes["Lilyut Hills"]["Ynystere"].cheeseValue = 29;
    stabNodes["Lilyut Hills"]["Villanelle"].fertValue = 19;
    stabNodes["Lilyut Hills"]["Villanelle"].honeyValue = 32;
    stabNodes["Lilyut Hills"]["Villanelle"].cheeseValue = 32;
    stabNodes["Lilyut Hills"]["Solis Headlands"].fertValue = 18;
    stabNodes["Lilyut Hills"]["Solis Headlands"].honeyValue = 30;
    stabNodes["Lilyut Hills"]["Solis Headlands"].cheeseValue = 30;
    stabNodes["Lilyut Hills"]["Freedich Island"].fertValue = 1;
    stabNodes["Lilyut Hills"]["Freedich Island"].honeyValue = 3;
    stabNodes["Lilyut Hills"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Dewstone Plains"]["Ynystere"].fertValue = 19;
    stabNodes["Dewstone Plains"]["Ynystere"].honeyValue = 31;
    stabNodes["Dewstone Plains"]["Ynystere"].cheeseValue = 31;
    stabNodes["Dewstone Plains"]["Villanelle"].fertValue = 19;
    stabNodes["Dewstone Plains"]["Villanelle"].honeyValue = 32;
    stabNodes["Dewstone Plains"]["Villanelle"].cheeseValue = 32;
    stabNodes["Dewstone Plains"]["Solis Headlands"].fertValue = 16;
    stabNodes["Dewstone Plains"]["Solis Headlands"].honeyValue = 27;
    stabNodes["Dewstone Plains"]["Solis Headlands"].cheeseValue = 27;
    stabNodes["Dewstone Plains"]["Freedich Island"].fertValue = 1;
    stabNodes["Dewstone Plains"]["Freedich Island"].honeyValue = 3;
    stabNodes["Dewstone Plains"]["Freedich Island"].cheeseValue = 3;
    stabNodes["White Arden"]["Ynystere"].fertValue = 20;
    stabNodes["White Arden"]["Ynystere"].honeyValue = 34;
    stabNodes["White Arden"]["Ynystere"].cheeseValue = 34;
    stabNodes["White Arden"]["Villanelle"].fertValue = 21;
    stabNodes["White Arden"]["Villanelle"].honeyValue = 34;
    stabNodes["White Arden"]["Villanelle"].cheeseValue = 34;
    stabNodes["White Arden"]["Solis Headlands"].fertValue = 17;
    stabNodes["White Arden"]["Solis Headlands"].honeyValue = 28;
    stabNodes["White Arden"]["Solis Headlands"].cheeseValue = 28;
    stabNodes["White Arden"]["Freedich Island"].fertValue = 1;
    stabNodes["White Arden"]["Freedich Island"].honeyValue = 3;
    stabNodes["White Arden"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Marianople"]["Ynystere"].fertValue = 19;
    stabNodes["Marianople"]["Ynystere"].honeyValue = 32;
    stabNodes["Marianople"]["Ynystere"].cheeseValue = 32;
    stabNodes["Marianople"]["Villanelle"].fertValue = 19;
    stabNodes["Marianople"]["Villanelle"].honeyValue = 32;
    stabNodes["Marianople"]["Villanelle"].cheeseValue = 32;
    stabNodes["Marianople"]["Solis Headlands"].fertValue = 15;
    stabNodes["Marianople"]["Solis Headlands"].honeyValue = 25;
    stabNodes["Marianople"]["Solis Headlands"].cheeseValue = 25;
    stabNodes["Marianople"]["Freedich Island"].fertValue = 1;
    stabNodes["Marianople"]["Freedich Island"].honeyValue = 3;
    stabNodes["Marianople"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Two Crowns"]["Ynystere"].fertValue = 17;
    stabNodes["Two Crowns"]["Ynystere"].honeyValue = 27;
    stabNodes["Two Crowns"]["Ynystere"].cheeseValue = 27;
    stabNodes["Two Crowns"]["Villanelle"].fertValue = 16;
    stabNodes["Two Crowns"]["Villanelle"].honeyValue = 26;
    stabNodes["Two Crowns"]["Villanelle"].cheeseValue = 26;
    stabNodes["Two Crowns"]["Solis Headlands"].fertValue = 12;
    stabNodes["Two Crowns"]["Solis Headlands"].honeyValue = 19;
    stabNodes["Two Crowns"]["Solis Headlands"].cheeseValue = 19;
    stabNodes["Two Crowns"]["Freedich Island"].fertValue = 1;
    stabNodes["Two Crowns"]["Freedich Island"].honeyValue = 3;
    stabNodes["Two Crowns"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Cinderstone Moor"]["Ynystere"].fertValue = 15;
    stabNodes["Cinderstone Moor"]["Ynystere"].honeyValue = 24;
    stabNodes["Cinderstone Moor"]["Ynystere"].cheeseValue = 24;
    stabNodes["Cinderstone Moor"]["Villanelle"].fertValue = 14;
    stabNodes["Cinderstone Moor"]["Villanelle"].honeyValue = 23;
    stabNodes["Cinderstone Moor"]["Villanelle"].cheeseValue = 23;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].fertValue = 11;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].honeyValue = 17;
    stabNodes["Cinderstone Moor"]["Solis Headlands"].cheeseValue = 17;
    stabNodes["Cinderstone Moor"]["Freedich Island"].fertValue = 1;
    stabNodes["Cinderstone Moor"]["Freedich Island"].honeyValue = 3;
    stabNodes["Cinderstone Moor"]["Freedich Island"].cheeseValue = 3;
    stabNodes["Halcyona"]["Ynystere"].fertValue = 22;
    stabNodes["Halcyona"]["Ynystere"].honeyValue = 37;
    stabNodes["Halcyona"]["Ynystere"].cheeseValue = 37;
    stabNodes["Halcyona"]["Villanelle"].fertValue = 21;
    stabNodes["Halcyona"]["Villanelle"].honeyValue = 36;
    stabNodes["Halcyona"]["Villanelle"].cheeseValue = 36;
    stabNodes["Halcyona"]["Solis Headlands"].fertValue = 17;
    stabNodes["Halcyona"]["Solis Headlands"].honeyValue = 28;
    stabNodes["Halcyona"]["Solis Headlands"].cheeseValue = 28;
    stabNodes["Halcyona"]["Freedich Island"].fertValue = 1;
    stabNodes["Halcyona"]["Freedich Island"].honeyValue = 4;
    stabNodes["Halcyona"]["Freedich Island"].cheeseValue = 4;
    stabNodes["Hellswamp"]["Ynystere"].fertValue = 25;
    stabNodes["Hellswamp"]["Ynystere"].honeyValue = 42;
    stabNodes["Hellswamp"]["Ynystere"].cheeseValue = 42;
    stabNodes["Hellswamp"]["Villanelle"].fertValue = 24;
    stabNodes["Hellswamp"]["Villanelle"].honeyValue = 40;
    stabNodes["Hellswamp"]["Villanelle"].cheeseValue = 40;
    stabNodes["Hellswamp"]["Solis Headlands"].fertValue = 19;
    stabNodes["Hellswamp"]["Solis Headlands"].honeyValue = 32;
    stabNodes["Hellswamp"]["Solis Headlands"].cheeseValue = 32;
    stabNodes["Hellswamp"]["Freedich Island"].fertValue = 1;
    stabNodes["Hellswamp"]["Freedich Island"].honeyValue = 4;
    stabNodes["Hellswamp"]["Freedich Island"].cheeseValue = 4;
    stabNodes["Sanddeep"]["Ynystere"].fertValue = 21;
    stabNodes["Sanddeep"]["Ynystere"].honeyValue = 35;
    stabNodes["Sanddeep"]["Ynystere"].cheeseValue = 35;
    stabNodes["Sanddeep"]["Villanelle"].fertValue = 20;
    stabNodes["Sanddeep"]["Villanelle"].honeyValue = 34;
    stabNodes["Sanddeep"]["Villanelle"].cheeseValue = 34;
    stabNodes["Sanddeep"]["Solis Headlands"].fertValue = 15;
    stabNodes["Sanddeep"]["Solis Headlands"].honeyValue = 25;
    stabNodes["Sanddeep"]["Solis Headlands"].cheeseValue = 25;
    stabNodes["Sanddeep"]["Freedich Island"].fertValue = 1;
    stabNodes["Sanddeep"]["Freedich Island"].honeyValue = 4;
    stabNodes["Sanddeep"]["Freedich Island"].cheeseValue = 4;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].fertValue = 43;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].honeyValue = 72;
    stabNodes["Karkasse Ridgelands"]["Ynystere"].cheeseValue = 72;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].fertValue = 45;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].honeyValue = 75;
    stabNodes["Karkasse Ridgelands"]["Villanelle"].cheeseValue = 75;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].fertValue = 42;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].honeyValue = 70;
    stabNodes["Karkasse Ridgelands"]["Solis Headlands"].cheeseValue = 70;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].fertValue = 2;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].honeyValue = 6;
    stabNodes["Karkasse Ridgelands"]["Freedich Island"].cheeseValue = 6;
    stabNodes["Airain Rock"]["Ynystere"].fertValue = 25;
    stabNodes["Airain Rock"]["Ynystere"].honeyValue = 42;
    stabNodes["Airain Rock"]["Ynystere"].cheeseValue = 42;
    stabNodes["Airain Rock"]["Villanelle"].fertValue = 26;
    stabNodes["Airain Rock"]["Villanelle"].honeyValue = 43;
    stabNodes["Airain Rock"]["Villanelle"].cheeseValue = 43;
    stabNodes["Airain Rock"]["Solis Headlands"].fertValue = 22;
    stabNodes["Airain Rock"]["Solis Headlands"].honeyValue = 36;
    stabNodes["Airain Rock"]["Solis Headlands"].cheeseValue = 36;
    stabNodes["Airain Rock"]["Freedich Island"].fertValue = 1;
    stabNodes["Airain Rock"]["Freedich Island"].honeyValue = 4;
    stabNodes["Airain Rock"]["Freedich Island"].cheeseValue = 4;
    stabNodes["Aubre Cradle"]["Ynystere"].fertValue = 23;
    stabNodes["Aubre Cradle"]["Ynystere"].honeyValue = 38;
    stabNodes["Aubre Cradle"]["Ynystere"].cheeseValue = 38;
    stabNodes["Aubre Cradle"]["Villanelle"].fertValue = 33;
    stabNodes["Aubre Cradle"]["Villanelle"].honeyValue = 39;
    stabNodes["Aubre Cradle"]["Villanelle"].cheeseValue = 39;
    stabNodes["Aubre Cradle"]["Solis Headlands"].fertValue = 19;
    stabNodes["Aubre Cradle"]["Solis Headlands"].honeyValue = 32;
    stabNodes["Aubre Cradle"]["Solis Headlands"].cheeseValue = 32;
    stabNodes["Aubre Cradle"]["Freedich Island"].fertValue = 1;
    stabNodes["Aubre Cradle"]["Freedich Island"].honeyValue = 4;
    stabNodes["Aubre Cradle"]["Freedich Island"].cheeseValue = 4;
    stabNodes["Ahnimar"]["Ynystere"].fertValue = 27;
    stabNodes["Ahnimar"]["Ynystere"].honeyValue = 46;
    stabNodes["Ahnimar"]["Ynystere"].cheeseValue = 46;
    stabNodes["Ahnimar"]["Villanelle"].fertValue = 27;
    stabNodes["Ahnimar"]["Villanelle"].honeyValue = 45;
    stabNodes["Ahnimar"]["Villanelle"].cheeseValue = 45;
    stabNodes["Ahnimar"]["Solis Headlands"].fertValue = 22;
    stabNodes["Ahnimar"]["Solis Headlands"].honeyValue = 36;
    stabNodes["Ahnimar"]["Solis Headlands"].cheeseValue = 36;
    stabNodes["Ahnimar"]["Freedich Island"].fertValue = 2;
    stabNodes["Ahnimar"]["Freedich Island"].honeyValue = 4;
    stabNodes["Ahnimar"]["Freedich Island"].cheeseValue = 4;
}
import { writeFile } from 'fs/promises';

// Combine the JSON strings for different node types
const combinedJsonString = JSON.stringify({
  goldNodes,
  gildaNodes,
  stabNodes
}, null, 2); // null and 2 for pretty-printing

// Define an async function to write the JSON data to a file
const writeJsonToFile = async () => {
  try {
    // Write the JSON string to a file named 'Output.txt'
    await writeFile('Output.txt', combinedJsonString);
